...
function itax2122() {
  ...
  var ecess;
  var inc =
    document.getElementById("tinc").value * 1 -
  ...
  if (inc > 5000000 && inc <= 10000000) {
    ...
    if (
      surch > 0 &&
      (age == "b60" || age == "huf") &&
      inc * 1 - tax * 1.1 <= 3687500
    ) {
      mtr = surch * 1 - (inc * 1 - 3687500 * 1 - tax * 1);
    }
    if (surch > 0 && age == "a60" && inc * 1 - tax * 1.1 <= 3690000) {
      mtr = surch * 1 - (inc * 1 - 3690000 * 1 - tax * 1);
    }
    if (surch > 0 && age == "a80" && inc * 1 - tax * 1.1 <= 3700000) {
